...
import com.ruoyi.common.wx.entity.OAuth2AccessToken;
import com.ruoyi.common.wx.entity.WXOAuthUserInfo;
...
public class WXOAuth2AuthorizeUtil {
    private static Logger logger = LoggerFactory.getLogger(WXOAuth2AuthorizeUtil.class);
